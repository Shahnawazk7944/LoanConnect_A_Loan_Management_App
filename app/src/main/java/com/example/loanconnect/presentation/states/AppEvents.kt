...
sealed class AppEvents {
    data class ApplyForLoan(val contactNumber: String, val amount: Int, val duration: Int) :
        AppEvents()
    ...
    data class UpdateNewMobileNumber(val newData: String, val mobileNumberAsId: String) :
        AppEvents()
